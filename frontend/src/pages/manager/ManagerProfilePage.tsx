...
export default function ManagerProfilePage() {
  ...
  return (
    <AppLayout
      ...
      sidebarItems={[
        { label: "Dashboard", icon: LayoutDashboard, onClick: () => navigate(ROUTES.manager.dashboard) },
        { label: "Incidents", icon: FileText, onClick: () => navigate(ROUTES.manager.incidents) },
        { label: "Profile", icon: User, active: true, onClick: () => navigate(ROUTES.manager.profile) },
      ]}
